	...
	<div style="background-color: #efefef">
		<div class="container">
			<div class="section-card" style="padding: 20px 0px">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #635c73;">HASIL REKOMENDASI CAFE</h4>
				</center>
				<ul>
					<li>
						<div class="row">
							<div class="card">
								<div class="card-content">
									<h5 style="margin-bottom: 16px; margin-top: -6px;">Matrik Cafe</h5>
									<table class="responsive-table">
										...
										<tbody>
											...
											$no=1;
											while ($data_cafe=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($data_cafe['harga_angka'],$data_cafe['rating_angka'],$data_cafe['jam_angka'],$data_cafe['fasilitas_angka'],$data_cafe['comfy_angka'] );
												?>
												<tr>
													<td><center><?php echo "A",$no ?></center></td>
													<td><center><?php echo $data_cafe['harga_angka'] ?></center></td>
													<td><center><?php echo $data_cafe['rating_angka'] ?></center></td>
													<td><center><?php echo $data_cafe['jam_angka'] ?></center></td>
													<td><center><?php echo $data_cafe['fasilitas_angka'] ?></center></td>
													<td><center><?php echo $data_cafe['comfy_angka'] ?></center></td>
												</tr>
												<?php
												$no++;
											}
									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_cafe=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($data_cafe['harga_angka']/$pembagiNM[0],
													$data_cafe['rating_angka']/$pembagiNM[1],
													$data_cafe['jam_angka']/$pembagiNM[2],
													$data_cafe['fasilitas_angka']/$pembagiNM[3],
													$data_cafe['comfy_angka']/$pembagiNM[4]);

													?>
													<tr>
														<td><center><?php echo "A",$no ?></center></td>
														<td><center><?php echo round($data_cafe['harga_angka']/$pembagiNM[0],6)?></center></td>
														<td><center><?php echo round($data_cafe['rating_angka']/$pembagiNM[1],6) ?></center></td>
														<td><center><?php echo round($data_cafe['jam_angka']/$pembagiNM[2],6) ?></center></td>
														<td><center><?php echo round($data_cafe['fasilitas_angka']/$pembagiNM[3],6) ?></center></td>
														<td><center><?php echo round($data_cafe['comfy_angka']/$pembagiNM[4],6) ?></center></td>
													</tr>
													<?php
													$no++;
												}
										...
										<table class="responsive-table">
											<thead>
												<tr>
													...
													<th><center>Value Kriteria Rating</center></th>
													<th><center>Value Kriteria Jam</center></th>
													<th><center>Value Kriteria Fasilitas</center></th>
													<th><center>Value Kriteria Kenyamanan</center></th>
												</tr>
											</thead>
											<tbody>
												<!--count($W)-->
												...
												<tbody>
													<tr>
														...
														for ($i=0; $i < count($nilaiV); $i++) { 
															if ($nilaiV[$i] == $testmax) {
																$query=mysqli_query($selectdb,"SELECT * FROM data_cafe where id_cafe = $i+1");
																?>
